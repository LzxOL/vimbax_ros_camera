...
#include "vimbax_camera_msgs/msg/detail/event_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vimbax_camera_msgs::msg::EventDataEntry &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  vimbax_camera_msgs::msg::EventDataEntry &);
...
cdr_serialize(
  const vimbax_camera_msgs::msg::EventData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vimbax_camera_msgs::msg::EventData & ros_message)
{
  // Member: entries
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: entries
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vimbax_camera_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_EventDataEntry(
  ...
  if (is_plain) {
    ...
    using DataType = vimbax_camera_msgs::msg::EventData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vimbax_camera_msgs::msg::EventData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vimbax_camera_msgs::msg::EventData *>(
    untyped_ros_message);
...
{
  return &vimbax_camera_msgs::msg::typesupport_fastrtps_cpp::_EventData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vimbax_camera_msgs, msg, EventData)() {
  return &vimbax_camera_msgs::msg::typesupport_fastrtps_cpp::_EventData__handle;
}

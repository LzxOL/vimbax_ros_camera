...
#include "vimbax_camera_msgs/msg/detail/event_data__rosidl_typesupport_fastrtps_c.h"
...
#include "vimbax_camera_msgs/msg/detail/event_data_entry__functions.h"  // entries
...
using _EventData__ros_msg_type = vimbax_camera_msgs__msg__EventData;
  ...
  // Field name: entries
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vimbax_camera_msgs, msg, EventDataEntry
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: entries
  {
    ...
    if (ros_message->entries.data) {
      vimbax_camera_msgs__msg__EventDataEntry__Sequence__fini(&ros_message->entries);
    }
    if (!vimbax_camera_msgs__msg__EventDataEntry__Sequence__init(&ros_message->entries, size)) {
      fprintf(stderr, "failed to create array for field 'entries'");
      return false;
    }
    auto array_ptr = ros_message->entries.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_vimbax_camera_msgs__msg__EventData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EventData__ros_msg_type * ros_message = static_cast<const _EventData__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name entries
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_vimbax_camera_msgs__msg__EventDataEntry(
...
static uint32_t _EventData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vimbax_camera_msgs__msg__EventData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vimbax_camera_msgs
size_t max_serialized_size_vimbax_camera_msgs__msg__EventData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: entries
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_vimbax_camera_msgs__msg__EventDataEntry(
  ...
  if (is_plain) {
    ...
    using DataType = vimbax_camera_msgs__msg__EventData;
    is_plain =
      (
      offsetof(DataType, entries) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _EventData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vimbax_camera_msgs__msg__EventData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vimbax_camera_msgs, msg, EventData)() {

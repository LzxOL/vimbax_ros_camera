...
#include "vimbax_camera_msgs/msg/detail/error__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vimbax_camera_msgs::msg::Error & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vimbax_camera_msgs::msg::Error & ros_message)
{
  // Member: code
  cdr >> ros_message.code;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vimbax_camera_msgs::msg::Error;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vimbax_camera_msgs::msg::Error *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vimbax_camera_msgs::msg::Error *>(
    untyped_ros_message);
...
{
  return &vimbax_camera_msgs::msg::typesupport_fastrtps_cpp::_Error__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vimbax_camera_msgs, msg, Error)() {
  return &vimbax_camera_msgs::msg::typesupport_fastrtps_cpp::_Error__handle;
}

...
static const _EventDataEntry_type_support_symbol_names_t _EventDataEntry_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vimbax_camera_msgs, msg, EventDataEntry)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vimbax_camera_msgs, msg, EventDataEntry)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vimbax_camera_msgs, msg, EventDataEntry)() {
  return &::vimbax_camera_msgs::msg::rosidl_typesupport_c::EventDataEntry_message_type_support_handle;
}

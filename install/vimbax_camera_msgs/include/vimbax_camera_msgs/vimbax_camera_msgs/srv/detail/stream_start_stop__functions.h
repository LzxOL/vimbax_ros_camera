...
#ifndef VIMBAX_CAMERA_MSGS__SRV__DETAIL__STREAM_START_STOP__FUNCTIONS_H_
#define VIMBAX_CAMERA_MSGS__SRV__DETAIL__STREAM_START_STOP__FUNCTIONS_H_
...
/// Initialize srv/StreamStartStop message.
/**
...
/// Finalize srv/StreamStartStop message.
/**
...
/// Create srv/StreamStartStop message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vimbax_camera_msgs__srv__StreamStartStop_Request__init().
...
/// Destroy srv/StreamStartStop message.
/**
 * It calls
 * vimbax_camera_msgs__srv__StreamStartStop_Request__fini()
...
/// Check for srv/StreamStartStop message equality.
/**
...
/// Copy a srv/StreamStartStop message.
/**
...
/// Initialize array of srv/StreamStartStop messages.
/**
...
/// Finalize array of srv/StreamStartStop messages.
/**
 * It calls
 * vimbax_camera_msgs__srv__StreamStartStop_Request__fini()
...
/// Create array of srv/StreamStartStop messages.
/**
 * It allocates the memory for the array and calls
 * vimbax_camera_msgs__srv__StreamStartStop_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/StreamStartStop messages.
/**
 * It calls
 * vimbax_camera_msgs__srv__StreamStartStop_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/StreamStartStop message array equality.
/**
...
/// Copy an array of srv/StreamStartStop messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vimbax_camera_msgs__srv__StreamStartStop_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vimbax_camera_msgs
...
/**
 * It calls
 * vimbax_camera_msgs__srv__StreamStartStop_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vimbax_camera_msgs
...
/**
 * It allocates the memory for the array and calls
 * vimbax_camera_msgs__srv__StreamStartStop_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vimbax_camera_msgs
...
/**
 * It calls
 * vimbax_camera_msgs__srv__StreamStartStop_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VIMBAX_CAMERA_MSGS__SRV__DETAIL__STREAM_START_STOP__FUNCTIONS_H_

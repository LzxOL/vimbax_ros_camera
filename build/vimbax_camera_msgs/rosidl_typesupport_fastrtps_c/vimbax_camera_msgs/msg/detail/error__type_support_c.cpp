...
#include "vimbax_camera_msgs/msg/detail/error__rosidl_typesupport_fastrtps_c.h"
...
using _Error__ros_msg_type = vimbax_camera_msgs__msg__Error;
...
static uint32_t _Error__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vimbax_camera_msgs__msg__Error(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vimbax_camera_msgs__msg__Error;
    is_plain =
      (
...
static size_t _Error__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vimbax_camera_msgs__msg__Error(

...
bool vimbax_camera_msgs__msg__error__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vimbax_camera_msgs.msg._error.Error", full_classname_dest, 35) == 0);
  }
  vimbax_camera_msgs__msg__Error * ros_message = _ros_message;
  {  // code
...
PyObject * vimbax_camera_msgs__msg__error__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vimbax_camera_msgs.msg._error");

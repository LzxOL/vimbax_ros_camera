...
#include "vimbax_camera_msgs/msg/detail/feature_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vimbax_camera_msgs::msg::FeatureFlags &,
...
size_t
max_serialized_size_FeatureFlags(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const vimbax_camera_msgs::msg::FeatureInfo & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.sfnc_namespace;
  // Member: unit
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vimbax_camera_msgs::msg::FeatureInfo & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  // Member: flags
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vimbax_camera_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_FeatureFlags(
  ...
  if (is_plain) {
    ...
    using DataType = vimbax_camera_msgs::msg::FeatureInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vimbax_camera_msgs::msg::FeatureInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vimbax_camera_msgs::msg::FeatureInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FeatureInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vimbax_camera_msgs::msg::FeatureInfo *>(
...
static size_t _FeatureInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FeatureInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FeatureInfo__callbacks = {
...
static rosidl_message_type_support_t _FeatureInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FeatureInfo__callbacks,
...
{
  return &vimbax_camera_msgs::msg::typesupport_fastrtps_cpp::_FeatureInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vimbax_camera_msgs, msg, FeatureInfo)() {
  return &vimbax_camera_msgs::msg::typesupport_fastrtps_cpp::_FeatureInfo__handle;
}

...
vimbax_camera_msgs__srv__FeatureStringGet_Request__init(vimbax_camera_msgs__srv__FeatureStringGet_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->feature_name)) {
    vimbax_camera_msgs__srv__FeatureStringGet_Request__fini(msg);
    return false;
  }
  // feature_module
...
vimbax_camera_msgs__srv__FeatureStringGet_Request__create()
{
  ...
  vimbax_camera_msgs__srv__FeatureStringGet_Request * msg = (vimbax_camera_msgs__srv__FeatureStringGet_Request *)allocator.allocate(sizeof(vimbax_camera_msgs__srv__FeatureStringGet_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vimbax_camera_msgs__srv__FeatureStringGet_Request));
  bool success = vimbax_camera_msgs__srv__FeatureStringGet_Request__init(msg);
  if (!success) {
...
vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence__init(vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vimbax_camera_msgs__srv__FeatureStringGet_Request * data = NULL;

  if (size) {
    data = (vimbax_camera_msgs__srv__FeatureStringGet_Request *)allocator.zero_allocate(size, sizeof(vimbax_camera_msgs__srv__FeatureStringGet_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vimbax_camera_msgs__srv__FeatureStringGet_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        vimbax_camera_msgs__srv__FeatureStringGet_Request__fini(&data[i - 1]);
      }
...
vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence__fini(vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      vimbax_camera_msgs__srv__FeatureStringGet_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence * array = (vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence *)allocator.allocate(sizeof(vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence__init(array, size);
  if (!success) {
...
vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence__destroy(vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence__are_equal(const vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence * lhs, const vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vimbax_camera_msgs__srv__FeatureStringGet_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vimbax_camera_msgs__srv__FeatureStringGet_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vimbax_camera_msgs__srv__FeatureStringGet_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vimbax_camera_msgs__srv__FeatureStringGet_Request * data =
      (vimbax_camera_msgs__srv__FeatureStringGet_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vimbax_camera_msgs__srv__FeatureStringGet_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vimbax_camera_msgs__srv__FeatureStringGet_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!vimbax_camera_msgs__srv__FeatureStringGet_Request__copy(
...
vimbax_camera_msgs__srv__FeatureStringGet_Response__init(vimbax_camera_msgs__srv__FeatureStringGet_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->value)) {
    vimbax_camera_msgs__srv__FeatureStringGet_Response__fini(msg);
    return false;
  }
  // error
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vimbax_camera_msgs__srv__FeatureStringGet_Response * msg = (vimbax_camera_msgs__srv__FeatureStringGet_Response *)allocator.allocate(sizeof(vimbax_camera_msgs__srv__FeatureStringGet_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vimbax_camera_msgs__srv__FeatureStringGet_Response));
  bool success = vimbax_camera_msgs__srv__FeatureStringGet_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence__init(vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vimbax_camera_msgs__srv__FeatureStringGet_Response * data = NULL;

  if (size) {
    data = (vimbax_camera_msgs__srv__FeatureStringGet_Response *)allocator.zero_allocate(size, sizeof(vimbax_camera_msgs__srv__FeatureStringGet_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vimbax_camera_msgs__srv__FeatureStringGet_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        vimbax_camera_msgs__srv__FeatureStringGet_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence__fini(vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      vimbax_camera_msgs__srv__FeatureStringGet_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence * array = (vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence *)allocator.allocate(sizeof(vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence__destroy(vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence__are_equal(const vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence * lhs, const vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vimbax_camera_msgs__srv__FeatureStringGet_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vimbax_camera_msgs__srv__FeatureStringGet_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vimbax_camera_msgs__srv__FeatureStringGet_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vimbax_camera_msgs__srv__FeatureStringGet_Response * data =
      (vimbax_camera_msgs__srv__FeatureStringGet_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vimbax_camera_msgs__srv__FeatureStringGet_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vimbax_camera_msgs__srv__FeatureStringGet_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!vimbax_camera_msgs__srv__FeatureStringGet_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }

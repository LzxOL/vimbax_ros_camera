...
bool vimbax_camera_msgs__msg__event_data_entry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vimbax_camera_msgs.msg._event_data_entry.EventDataEntry", full_classname_dest, 55) == 0);
  }
  vimbax_camera_msgs__msg__EventDataEntry * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of EventDataEntry */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vimbax_camera_msgs.msg._event_data_entry");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EventDataEntry");

...
bool vimbax_camera_msgs__srv__feature_bool_set__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vimbax_camera_msgs.srv._feature_bool_set.FeatureBoolSet_Request", full_classname_dest, 63) == 0);
  }
  vimbax_camera_msgs__srv__FeatureBoolSet_Request * ros_message = _ros_message;
  {  // feature_name
...
{
  /* NOTE(esteve): Call constructor of FeatureBoolSet_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vimbax_camera_msgs.srv._feature_bool_set");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FeatureBoolSet_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool vimbax_camera_msgs__srv__feature_bool_set__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vimbax_camera_msgs.srv._feature_bool_set.FeatureBoolSet_Response", full_classname_dest, 64) == 0);
  }
  vimbax_camera_msgs__srv__FeatureBoolSet_Response * ros_message = _ros_message;
  {  // error
...
{
  /* NOTE(esteve): Call constructor of FeatureBoolSet_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vimbax_camera_msgs.srv._feature_bool_set");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FeatureBoolSet_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);

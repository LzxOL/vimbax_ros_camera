    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'vimbax_camera_msgs.msg.EventData')
            logger.debug(
            ...
            from vimbax_camera_msgs.msg import EventDataEntry
            if EventDataEntry.__class__._TYPE_SUPPORT is None:
                EventDataEntry.__class__.__import_type_support__()
...
class EventData(metaclass=Metaclass_EventData):
    ...
    _fields_and_field_types = {
        'entries': 'sequence<vimbax_camera_msgs/EventDataEntry>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['vimbax_camera_msgs', 'msg'], 'EventDataEntry')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, EventDataEntry) for v in value) and
                 True), \
                "The 'entries' field must be a set or sequence and each value of type 'EventDataEntry'"
        self._entries = value

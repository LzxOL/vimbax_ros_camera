...
#ifndef VIMBAX_CAMERA_MSGS__SRV__DETAIL__STATUS__FUNCTIONS_H_
#define VIMBAX_CAMERA_MSGS__SRV__DETAIL__STATUS__FUNCTIONS_H_
 ...
 * calls
 * vimbax_camera_msgs__srv__Status_Request__init().
...
/**
 * It calls
 * vimbax_camera_msgs__srv__Status_Request__fini()
 ...
 * vimbax_camera_msgs__srv__Status_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * vimbax_camera_msgs__srv__Status_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vimbax_camera_msgs__srv__Status_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vimbax_camera_msgs
...
/**
 * It calls
 * vimbax_camera_msgs__srv__Status_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vimbax_camera_msgs
...
/**
 * It allocates the memory for the array and calls
 * vimbax_camera_msgs__srv__Status_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vimbax_camera_msgs
...
/**
 * It calls
 * vimbax_camera_msgs__srv__Status_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VIMBAX_CAMERA_MSGS__SRV__DETAIL__STATUS__FUNCTIONS_H_

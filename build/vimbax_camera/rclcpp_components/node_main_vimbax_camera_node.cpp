...
#define NODE_MAIN_LOGGER_NAME "vimbax_camera_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvimbax_camera.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<vimbax_camera::VimbaXCameraNode>";
